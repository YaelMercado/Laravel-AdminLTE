		...
		<div class="box-body" style="background-image: url(/img/fondo.png);background-size: cover;">
			<div class="row" style="height: calc(100vh - 220px) !important;">
                <div class="col-md-7">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="/img/logo_cer.png" style="width: 40%; padding:5px;" alt="">
                        </div>
                    </div>
                
                    <div class="col-md-12" style="margin: auto; padding-top: 2%; padding-bottom: 2%;">
                        
                        <video controls src="/img/certificaciones.mp4" style="width: 100%; padding:5px;" alt="">
                    </div>

                    <div class="col-md-12">
                        <div class="col-md-6 col-md-offset-3">
                                <a href="/course/view-into-course/{{$courses->id}}" class="btn btn-danger" style="color:white; width:100%; border-radius: 10px; margin-top: 10px;">OFERTAS DE Programas</a>
                        </div>
                    </div>
