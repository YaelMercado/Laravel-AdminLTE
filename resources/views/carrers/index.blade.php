...
@section('menu_pagina')	
	...
	<li role="presentation">
		<a href="{{ route('carrers.create') }}" class="link_menu_page">
						...
						<table id="tabelapadrao" class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										@if (Auth::user()->can('show-carrers', ''))
											<a class="btn btn-default  btn-xs" href="{{ route('carrers.show', $est->id) }}" title="Ver {{ $est->name }}"><i class="fa fa-eye">   </i></a>	
										@endif
										@if (Auth::user()->can('edit-carrers', ''))
											<a class="btn btn-warning  btn-xs" href="{{ route('carrers.edit', $est->id) }}" title="Editar {{ $est->name }}"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-primary  btn-xs" href="{{ route('carrers.add_semestre', $est->id) }}" title="Asignar semestres {{ $est->name }}"><i class="fa fa-calendar"></i></a>
