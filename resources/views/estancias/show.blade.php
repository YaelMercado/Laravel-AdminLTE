				...
				<div class="col-md-12">	
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-6">
                                ...
                                <select disabled class="form-control select2" name="type_estancia" id="type_estancia" required="required">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    ...
                                    <input disabled type="text" name="name" class="form-control" maxlength="30" minlength="4" placeholder="Nombre" required="" value="{{ $estancias->name }}" autofocus>
                                    @if($errors->has('name'))
                            ...
                            <div class="col-md-12 col-lg-12 col-12">
                                <div class="form-group ">
                                    ...
                                    <textarea disabled class="form-control" id="summary_ckeditor" name="summary_ckeditor" value="{{ $estancias->descripcion }}">{{ $estancias->descripcion }}</textarea>
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="date" class="form-control" required="required" id="inicio" name="inicio" value="{{ $estancias->fecha_inicio }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="date" class="form-control" required="required" id="fin" name="fin" value="{{ $estancias->fecha_fin }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                    ...
                                    <input disabled type="text" name="pais" class="form-control" placeholder="País" value="{{ $estancias->pais_destino }}">
                                    @if($errors->has('pais'))
                                        <span class="help-block">
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                    ...
                                    <input disabled type="text" name="universidad" class="form-control" placeholder="Universidad" value="{{ $estancias->universidad_destino }}" >
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="file" class="form-control-file" name="destino">
                                    <br>
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="file" class="form-control-file" name="unidestino">
                                    <br>
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="file" class="form-control-file" name="file-politicas-reglamento">
                            ...
                            <div class="col-md-6 col-lg-6 col-6">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="file" class="form-control-file" name="file-agenda">
                            ...
                            <div class="col-md-12 col-lg-12 col-12">
                                <div class="form-group ">
                                    ...
                                    <input disabled type="file" class="form-control-file" name="fondo">
                                    <br>
