...
@section('menu_pagina')	
	...
	<li role="presentation">
		<a href="/carrers/add_semestre/{{$carrers}}" class="link_menu_page">
...
@section('content')    
    ...
    <div class="box box-primary">
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">	
					 <form action="{{ route('semestre.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="carrers_id" value="{{$carrers}}">
