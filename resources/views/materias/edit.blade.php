...
@section('menu_pagina')	
	...
	<li role="presentation">
		<a href="/semestre/add_materias/{{$estancias->id_semestre}}" class="link_menu_page">
...
@section('content')    
    ...
    <div class="box box-primary">
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">	
					 <form action="{{ route('materias.update',$estancias->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
