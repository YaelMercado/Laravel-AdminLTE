...
@section('title', 'Configuración de Plataforma')
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <form action="{{ route('config.update',$config->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h4><b><i class="fa fa-fw fa-arrow-right"></i> Información General</b></h4>
                                <hr/>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group {{ $errors->has('app_name') ? 'has-error' : '' }}">
                                    <label for="nome">Nombre de la Aplicación</label>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group {{ $errors->has('app_name_abv') ? 'has-error' : '' }}">
                                    <label for="nome">Nombre corto</label>
                            ...
                            <div class="col-lg-12">
                                <br>
                                <h4><b><i class="fa fa-fw fa-arrow-right"></i> Captcha Inicio de sesión</b></h4>
                                <hr/>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group {{ $errors->has('captcha') ? 'has-error' : '' }}">
                                    <label for="nome">Captcha Inicio de sesión</label>
                            ...
                            <div class="col-lg-5">
                                <div class="form-group {{ $errors->has('datasitekey') ? 'has-error' : '' }}">
                                    <label for="nome">Clave de sitio</label>
                            ...
                            <div class="col-lg-5">
                                <div class="form-group {{ $errors->has('recaptcha_secret') ? 'has-error' : '' }}">
                                    <label for="nome">Clave secreta</label>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group {{ $errors->has('img_login') ? 'has-error' : '' }}">
                                    <label for="nome">Imagen inicio de sesión</label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('titulo_login') ? 'has-error' : '' }}">
                                    <label for="nome">Título inicio de sesión</label>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group {{ $errors->has('tamanho_img_login') ? 'has-error' : '' }}">
                                    <label for="nome">Tamaño de imagen inicio de sesión</label>
                            ...
                            <div class="col-lg-1">
                                <label>current Imagen de inicio de sesión</label>
                                <br>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group {{ $errors->has('caminho_img_login') ? 'has-error' : '' }}">
                                    <label>Imagen incio de sesión</label>
                            ...
                            <div class="col-lg-12">
                                <br>
                                <h4><b><i class="fa fa-fw fa-arrow-right"></i> Opciones de plantilla</b></h4>
                                <hr/>
                            </div> 
                            <div class="col-lg-4">
                                <div class="form-group {{ $errors->has('layout') ? 'has-error' : '' }}">
                                    <label for="nome">Plantilla</label>
