    ...
    @if($role->id != 1)    
        <div class="box box-primary">
    		<div class="box-body">
    			<div class="row">
    				<div class="col-md-12">	
                        <h4><b>Nombre:</b> {{ $role->name }}</h4>
    					<h4><b>Descripción:</b> {{ $role->label }}</h4>
                        <h4><b>Permisos:</b></h4>
                        ...
                        <div class="pull-right">               
                            <a href="{{ route('role.edit', $role->id) }}" title="Editar {{ $role->name }}"><button type="button" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-pencil"></i> Editar</button></a>
                        </div>
    				</div>
    			</div>
    		</div>
